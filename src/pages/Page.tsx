          ...
          <div className="pb60 welcome-page">
            <IonGrid>
              <IonRow className="ion-justify-content-center hide-xs">
                <IonCol sizeLg="4" sizeMd="3" size="7"></IonCol>
              </IonRow>
                  ...
                  <IonCard
                    ...
                    onClick={() => {
                      isLogedIn
                        ...
                        : alert("To complain you have to login");
                    }}
                  >
              ...
              <IonRow className="ion-justify-content-center">
                <IonCol sizeXs="12" size="10" sizeMd="6">
                  <IonCard className="tiny-padding" routerLink="/allFIR">
                    <IonCardHeader className="slim-padding">
                      <IonItem className="blank-item" lines="none">
                ...
                <IonRow className="ion-justify-content-center">
                  <IonCol sizeXs="12" size="10" sizeMd="6">
                    <IonCard
                      ...
                      onClick={() => {
                        canChange
                          ? (window.location.href = "/allFIR")
                          : alert(
                              "Sorry, it looks like you do not have necessary permissions to access it. This feature is restricted to admin user only."
                            );
                      }}
                    >
                      <IonCardHeader className="slim-padding">
              ...
              <IonRow className="ion-justify-content-center">
                <IonCol sizeXs="12" size="10" sizeMd="6">
                  <IonCard
                    ...
                    onClick={() => {
                      isLogedIn
                        ? (window.location.href = "/myCompaines")
                        : alert("To see your complains you have to login");
                    }}
                  >
                    <IonCardHeader className="slim-padding">
                      <IonItem className="blank-item" lines="none">
